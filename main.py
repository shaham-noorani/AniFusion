...
print("Enter the number of the first user (1 = Shaham, 2 = Kethan, 3 = Ryan):")
user1 = input()

print("Enter the number of the second user:")
user2 = input()
...
# user1_anime = parse_user_my_anime_lists(f"data/{user1}sAnimeList.xml")
# user2_anime = parse_user_my_anime_lists(f"data/{user2}sAnimeList.xml")
...
print(f"User {user1} recommendations: {user1_final_reccomendations}")
print(f"User {user2} recommendations: {user2_final_reccomendations}")
